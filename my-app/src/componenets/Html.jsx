   ...
   return loading?"Loading...":(
    <div >
...

     {
       ...
       <Button disabled={page===1} onClick={()=>{setPage(page-1)}} size="lg" bg="teal" color="white" _hover={{bg:"red"}}>-</Button><Button size="lg" bg="yellow">{page}</Button><Button onClick={()=>{setPage(page+1)}} size="lg" bg="teal" color="white" _hover={{bg:"red"}} disabled={page===total}>+</Button>
        </div>
    )
}
export default Html;